...
Original file is located at
    https://colab.research.google.com/drive/1oZUAeGXhZgtUjITsX3WKxK83U0mHhS3-
...
"""
        ...
        if df is not None and len(df) > 0:
            ...
            ejemplos_texto = '"# sustituye con tu path" → 1'
...
subset_balanceado = pd.read_parquet(path=path1)
subset_balanceado_exa = pd.read_parquet(path=path2)
...
finBin= subset_balanceado
subsetBin=subset_balanceado
